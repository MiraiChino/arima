...
- [x] prizeでターゲットエンコーディング
    ...
    - [x] 同じ騎手での賞金
    - [x] 1-距離差/今距離 x 賞金
    - [x] 同じ競馬場 x 1-距離差/今距離 x 賞金
    - [x] 同じ競馬場 x 同じ馬場 x 1-距離差/今距離 x 賞金
    - [x] 同じ競馬場 x 同じ馬場 x 枠 x 1-距離差/今距離 x 賞金
...
| 過去から計算 | (horse,jockey,barn)_interval_X | 過去X走からの平均レース間日数             | 1,2,3,4,5,10,all | 
|              | (horse,jockey,barn)_place_X    | 過去X走までの当日と同じ開催場所の経験回数 | 1,2,3,4,5,10,all | 
|              | (horse,jockey,barn)_odds_X     | 過去X走までの平均オッズ                   | 1,2,3,4,5,10,all | 
|              | (horse,jockey,barn)_pop_X      | 過去X走までの平均人気                     | 1,2,3,4,5,10,all | 
|              | (horse,jockey,barn)_result_X   | 過去X走までの平均着順                     | 1,2,3,4,5,10,all | 
|              | (horse,jockey,barn)_jockey_X   | 過去X走までの当日と同じ騎手と走った回数   | 1,2,3,4,5,10,all | 
|              | (horse,jockey,barn)_penalty_X  | 過去X走までの平均斤量                     | 1,2,3,4,5,10,all | 
|              | (horse,jockey,barn)_distance_X | 過去X走までの平均距離と当日の距離の差     | 1,2,3,4,5,10,all | 
|              | (horse,jockey,barn)_weather_X  | 過去X走までの当日と同じ天気を走った回数   | 1,2,3,4,5,10,all | 
|              | (horse,jockey,barn)_fc_X       | 過去X走までの当日と同じ馬場を走った回数   | 1,2,3,4,5,10,all | 
|              | (horse,jockey,barn)_time_X     | 過去X走までの平均タイムとの差の平均       | 1,2,3,4,5,10,all | 
|              | (horse,jockey,barn)_margin_X   | 過去X走までの平均着差                     | 1,2,3,4,5,10,all | 
|              | (horse,jockey,barn)_corner3_X  | 過去X走までの3コーナー平均通過順位        | 1,2,3,4,5,10,all | 
|              | (horse,jockey,barn)_corner4_X  | 過去X走までの4コーナー平均通過順位        | 1,2,3,4,5,10,all | 
|              | (horse,jockey,barn)_last3f_X   | 過去X走までの平均last3f                   | 1,2,3,4,5,10,all | 
|              | (horse,jockey,barn)_weight_X   | 過去X走までの平均体重                     | 1,2,3,4,5,10,all | 
|              | (horse,jockey,barn)_wc_X       | 過去X走までの平均体重変化                 | 1,2,3,4,5,10,all | 
|              | (horse,jockey,barn)_prize_X    | 過去X走までの平均獲得賞金                 | 1,2,3,4,5,10,all | 
