...
- 2008年1月1日〜2022年12月18日（13年分）

## 特徴量一覧
当日17+過去(46+30+25)*5=522
...
| 同馬の過去から計算(46) | horse_interval_X | 過去X走からの平均レース間日数 | 1,2,3,5,all |
|  | horse_odds_X | 過去X走までの平均オッズ | 1,2,3,5,all |
|  | horse_pop_X | 過去X走までの平均人気 | 1,2,3,5,all |
|  | horse_result_X | 過去X走までの平均着順 | 1,2,3,5,all |
|  | horse_penalty_X | 過去X走までの平均斤量 | 1,2,3,5,all |
|  | horse_weather_X | 過去X走までの当日と同じ天気を走った回数 | 1,2,3,5,all |
|  | horse_time_X | 過去X走までの平均タイムとの差の平均 | 1,2,3,5,all |
|  | horse_margin_X | 過去X走までの平均着差 | 1,2,3,5,all |
|  | horse_corner3_X | 過去X走までの3コーナー平均通過順位 | 1,2,3,5,all |
|  | horse_corner4_X | 過去X走までの4コーナー平均通過順位 | 1,2,3,5,all |
|  | horse_last3f_X | 過去X走までの平均last3f | 1,2,3,5,all |
|  | horse_weight_X | 過去X走までの平均体重 | 1,2,3,5,all |
|  | horse_wc_X | 過去X走までの平均体重変化 | 1,2,3,5,all |
|  | horse_tanshou_X | 過去X走までの平均1/単勝額 | 1,2,3,5,all |
|  | horse_hukushou_X | 過去X走までの平均1/複勝額 | 1,2,3,5,all |
|  | horse_score_X | 過去X走までの平均獲獲得スコア | 1,2,3,5,all |
|  | horse_prize_X | 過去X走までの平均獲得賞金 | 1,2,3,5,all |
|  | horse_Yprize_X | 過去X走までの同じ条件Yのレースの平均獲得賞金 | 1,2,3,5,all |
...
|  | horse_Ydrize_X | 過去X走までの同じ条件Yのレースの平均(1-距離差)/距離*賞金 | 1,2,3,5,all |
|  | Yの12パターン | なし　場所　芝/ダ　馬場　右/左　騎手 |  |
|  |  | 芝/ダ∧右/左　芝/ダ∧馬場　場所∧芝/ダ |  |
|  |  | 場所∧芝/ダ∧右/左　場所∧芝/ダ∧馬場 |  |
|  |  | 場所∧芝/ダ∧馬場∧右/左 |  |
| 同騎手の過去から計算(30) | jockey_interval_X | 過去X走からの平均レース間日数 | 1,2,3,5,all |
|  | jockey_odds_X | 過去X走までの平均オッズ | 1,2,3,5,all |
|  | jockey_pop_X | 過去X走までの平均人気 | 1,2,3,5,all |
|  | jockey_result_X | 過去X走までの平均着順 | 1,2,3,5,all |
|  | jockey_weather_X | 過去X走までの当日と同じ天気を走った回数 | 1,2,3,5,all |
|  | jockey_time_X | 過去X走までの平均タイムとの差の平均 | 1,2,3,5,all |
|  | jockey_margin_X | 過去X走までの平均着差 | 1,2,3,5,all |
|  | jockey_corner3_X | 過去X走までの3コーナー平均通過順位 | 1,2,3,5,all |
|  | jockey_corner4_X | 過去X走までの4コーナー平均通過順位 | 1,2,3,5,all |
|  | jockey_last3f_X | 過去X走までの平均last3f | 1,2,3,5,all |
|  | jockey_tanshou_X | 過去X走までの平均1/単勝額 |  |
|  | jockey_hukushou_X | 過去X走までの平均1/複勝額 |  |
|  | jockey_score_X | 過去X走までの平均獲獲得スコア |  |
|  | jockey_prize_X | 過去X走までの平均獲得賞金 | 1,2,3,5,all |
|  | jockey_Yprize_X | 過去X走までの同じ条件Yのレースの平均獲得賞金 | 1,2,3,5,all |
|  | Yの16パターン | 場所　距離　芝/ダ　馬場　右/左 |  |
|  |  | 芝/ダ∧右/左　芝/ダ∧距離　芝/ダ∧馬場 |  |
|  |  | 場所∧距離　場所∧芝/ダ　場所∧芝/ダ∧右/左 |  |
|  |  | 場所∧芝/ダ∧距離　場所∧芝/ダ∧馬場　距離∧芝/ダ∧馬場 |  |
|  |  | 場所∧芝/ダ∧距離∧馬場　場所∧芝/ダ∧距離∧右/左 |  |
| 同厩舎の過去から計算(25) | trainer_interval_X | 過去X走からの平均レース間日数 | 1,2,3,5,all |
|  | trainer_odds_X | 過去X走までの平均オッズ | 1,2,3,5,all |
|  | trainer_pop_X | 過去X走までの平均人気 | 1,2,3,5,all |
|  | trainer_result_X | 過去X走までの平均着順 | 1,2,3,5,all |
|  | trainer_time_X | 過去X走までの平均タイムとの差の平均 | 1,2,3,5,all |
|  | trainer_margin_X | 過去X走までの平均着差 | 1,2,3,5,all |
|  | trainer_corner3_X | 過去X走までの3コーナー平均通過順位 | 1,2,3,5,all |
|  | trainer_corner4_X | 過去X走までの4コーナー平均通過順位 | 1,2,3,5,all |
|  | trainer_last3f_X | 過去X走までの平均last3f | 1,2,3,5,all |
|  | trainer_tanshou_X | 過去X走までの平均1/単勝額 | 1,2,3,5,all |
|  | trainer_hukushou_X | 過去X走までの平均1/複勝額 | 1,2,3,5,all |
|  | trainer_score_X | 過去X走までの平均獲獲得スコア | 1,2,3,5,all |
|  | trainer_prize_X | 過去X走までの平均獲得賞金 | 1,2,3,5,all |
|  | trainer_Yprize_X | 過去X走までの同じ条件Yのレースの平均獲得賞金 | 1,2,3,5,all |
