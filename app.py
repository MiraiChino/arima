...
def handler(event, context):
    ...
    page = str(html(
        ...
        body(
            ...
            hr(),
            h3("単勝"),
            baken["単勝"].df.to_html(justify="center"),
            h3("馬連"),
            baken["馬連"].df.to_html(justify="center"),
            h3("馬単"),
            baken["馬単"].df.to_html(justify="center"),
            h3("三連複"),
            baken["三連複"].df.to_html(justify="center"),
            h3("三連単"),
            baken["三連単"].df.to_html(justify="center"),
        ),
        _lang="ja"
    ))
    return {
